...
{
    /// <summary>
    /// Checksum calculator for a 16-bit checksum
    /// </summary>
    public class Checksum16Calculator : IChecksumCalculator<ushort>
    {
        /// <summary>
        /// Default constructor
        /// </summary>
        ...
        public Checksum16Calculator(bool calculateForDecryptedData = true)
        {
        ...
        {
            ChecksumValue = (ushort)(ChecksumValue + b);
        }
        ...
        /// </summary>
        public ushort ChecksumValue { get; set; }
    }
}